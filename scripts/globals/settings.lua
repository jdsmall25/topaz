...
WEAPON_SKILL_POINTS = 25.000 -- Multiplies points earned during weapon unlocking.
...
DIG_ABUNDANCE_BONUS = 300 -- Increase chance of digging up an item (450  = item digup chance +45)
