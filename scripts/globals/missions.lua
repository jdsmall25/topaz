    ...
    if (nation == tpz.nation.SANDORIA) then
        if ((csid == 1009 or csid == 2009) and option ~= 1073741824 and option ~= 31) then
            ...
            timeline =
            {
                 ...
                 2, {1004, 0}, {2004, 0}, {0, 0},        {0, 0}, {{11, 2}, {3, "OptionalCSforSTC", 1}, {14, 0}, {6}, {8, 10000}, {12}},     -- MISSION 1-3
                 ...
                 5, {0, 0},      {0, 0},     {507, 0}, {0, 0}, {{10, 35}, {6}, {13, 207}, {8, 30000}, {11, 3}, {9, 29}, {14, 0}, {12}},     -- MISSION 2-3 (Halver)
                ...
                12, {0, 0},      {0, 0},     {39, 0}, {0, 0}, {{11, 4}, {14, 0}, {6}, {8, 50000}, {12}},                             -- MISSION 3-3 (Finish (Nelcabrit))
                13, {0, 0},      {0, 0},     {36, 0}, {0, 0}, {{11, 5}, {14, 0}, {13, 212}, {10, 69}, {6}, {8, 100000}, {12}, {1, 14}},     -- MISSION 4-1 (Finish (Nelcabrit))
                ...
                15, {0, 0},      {0, 0},     {61, 0}, {0, 0}, {{14, 0}, {9, 74}, {8, 200000}, {6}, {12}},                             -- MISSION 5-2 (Finish 2nd Part (Trion in Great Hall))
                16, {0, 0},      {0, 0},     {111, 0}, {0, 0}, {{14, 0}, {9, 268}, {10, 270}, {12}},                                 -- MISSION 6-1 (Finish (Chalvatot))
                17, {1034, 0}, {1033, 0}, {0, 0}, {0, 0}, {{14, 0}, {11, 7}, {8, 400000}, {6}, {12}},                                -- MISSION 6-2 (Finish (Guard))
                ...
                19, {1044, 0}, {1043, 0}, {0, 0}, {0, 0}, {{14, 0}, {6}, {3, "SecretWeaponStatus", 0}, {9, 284}, {11, 8}, {8, 600000}, {12}}, -- MISSION 7-2 (Finish)
                20, {0, 0},      {0, 0},     {102, 0}, {0, 0}, {{14, 0}, {9, 288}, {5, 800}, {12}},                                    -- MISSION 8-1 (Finish)
                21, {0, 0},     {0, 0},     {104, 0}, {0, 0}, {{14, 0}, {9, 284}, {11, 9}, {8, 800000}, {6}, {12}},                    -- MISSION 8-2 (Finish (Door: Great Hall))
